    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <ul class="nav navbar-nav">
          <li><a class="navbar-brand" href="./Main_page.php"><img src="images/rechargelogo.png" alt="logo" style="width:128px;height:60px; "></a></li>
          <li><a style="padding-right:30px;padding-left:30px;" href="./Main_page.php">Home</a></li>
        ...
        <ul class="nav navbar-nav navbar-right">
          <li><a href="Signup.php" style="padding-right:30px;padding-left:30px;"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
          <li><a href="Login.php" style="paddtravel-insurance-baging-right:30px;padding-left:30px;"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
        </ul>
      </div>
    </nav>
  </div>
              ...
              <div class="col-sm-12 col-md-10  col-md-offset-1 ">
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input class="form-control" placeholder="Name" name="fnm" type="text" autofocus required pattern="^[a-zA-Z]*$">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input class="form-control" placeholder="Email" name="email" type="email" ><!-- autofocus required pattern="^[A-Za-z0-9]+@[A-Z0-9a-z.-]+\.[A-Za-z]{2,}$"> -->
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input class="form-control" placeholder="Phone no." name="cnt" type="text" autofocus required pattern="[0-9]{10}">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                ...
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input class="form-control" placeholder="Password" name="password" type="password" value="" required pattern=".{6,}">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input class="form-control" placeholder="Confirm Password" name="cpassword" type="password" value="" required pattern=".{6,}">
                  </div>
                </div>
                <div class="form-group">
