            ...
            <div class="row">
              <div class="center-block">
                <img class="profile-img img-circle"
                  src="https://lh5.googleusercontent.com/-b0-k99FZlyE/AAAAAAAAAAI/AAAAAAAAAAA/eu7opA4byxI/photo.jpg?sz=120" style="margin-left:32%;" alt="">
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12 col-md-10  col-md-offset-1 ">
                ...
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input class="form-control" placeholder="Password" name="pwd" type="password" value="" required pattern=".{6,}">
                  </div>
                </div>
                <div class="form-group">
