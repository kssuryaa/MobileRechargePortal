...
<body style="background-color:black">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
          <ul class="nav navbar-nav">
            ...
            <li><a style="padding-right:30px;padding-left:30px;" href="Login.php">Recharge</a></li>
          </ul>
  ...
  <div class="bg">
    <div class="overlay"><h1 class="wow fadeInDown" style="z-index:3;text-align:center;font-size:4vw;padding-top:23%;color:gray;"><b>Online mobile recharge portal</b></h1>
    </div>
    </div>
